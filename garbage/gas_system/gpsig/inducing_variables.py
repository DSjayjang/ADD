...
from gpflow.params import Parameter, ParamList, Parameterized
...
class SignatureInducing(InducingPointsBase):
    ...
    """
    def __init__(self, Z, num_levels, learn_weights=False, name="SignatureInducing"):
        super().__init__(Z)
...
class InducingTensors(SignatureInducing):
    ...
    """
    def __init__(self, Z, num_levels, increments=False, name="InducingTensors", **kwargs):
